...
public class DownloadController {
    ...
    public static void insertDownloadInfo(String videoId, String title) {
        insertDownloadInfo(videoId, title, 0, MediaUtil.DOWNLOAD_MODE);
    }

    //新增下载信息
    public static void insertDownloadInfo(String videoId, String title, int definition, MediaMode downloadMode) {
